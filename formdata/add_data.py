...
import pickle
# Khởi tạo Firebase
cred = credentials.Certificate("D:\\1test\\Du_An_ung_dung\\serviceAccountKey.json")
...
class Ui_add_Data(object):
    ...
    def run_EncodeGenerator(self, folder_path="Images", encoding_file_path="EncodeFile.p"):
        ...
        for blob in blobs:
            ...
            if blob.name.lower().endswith('.png'):
                try:
                    ...
                    _, file_name = os.path.split(blob.name)
